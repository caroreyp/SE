 ...
 * 2012
 */
public class AdicionarDatosEscala extends JDialog implements ActionListener
{
	private JTable tbnombre;
	private JTable tbdescripcion;
	private JButton btaceptar;
	private JButton btcancelar;
	private JButton btcaracteristica;
	...
	public AdicionarDatosEscala(InterfazInicio interfaz)
	{
		super(interfaz, true);
		setLayout(new FlowLayout());
        setTitle("Adicionar Datos Escala - SESP");
        setResizable(false);
	    ...
	    tcm3.getColumn(1).setPreferredWidth(540);
	  ...
	  //********************************************
		...
		btcaracteristica = new JButton("Adicionar Caracteristica");
		btcaracteristica.addActionListener(this);
		btcaracteristica.setActionCommand("Adicionar Caracteristica");
		btcaracteristica.setPreferredSize(new Dimension(230,24));
		btcaracteristica.setBackground(new Color(60,116,107));
		btcaracteristica.setForeground(new Color(187,192,125));
		btcaracteristica.setFont(new Font( "dandelion in the spring", Font.TRUETYPE_FONT, 24 ));
		btcaracteristica.setToolTipText("Agregar una Caracterisitca a la Escala Actual.");
	...
	public void actionPerformed(ActionEvent evento){
		...
		if (clic.equals("Aceptar"))
		{
			...
			{
				JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir el nombre de la escala.","Adicionar Escala",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
			}
			else
			{
				...
				{
					JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir la descripcion de la escala.","Adicionar Escala",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
				}
				else
				{
					Escala nuevaescala = new Escala();
					nuevaescala.setNombre(nombredigitado.trim());
					nuevaescala.setDescripcion(descripciondigitado.trim());
					try 
		    		{
		    			...
		    			if(existen == null)
		    			{
			    			...
			    			EscalaBD.insertar(nuevaescala, conectorc);
		    				conectorc.terminarConexionBaseDatos();
			    			JOptionPane.showMessageDialog(this,"Se Adiciono la escala como base del conocimiento.","Adicionar Escala", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
			    			inicio.adicionarCaracteristicasEscala(nombredigitado.trim());
		    			}
		    			else
		    			{
		    				JOptionPane.showMessageDialog(this,"La escala con el nombre "+nombredigitado+" ya esta adicionada.","Adicionar Escala", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
		    			}
		    		}
		    		catch (Exception e)
		    		{
