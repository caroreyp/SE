 ...
 * 2012
 */
public class ModificarReglaConocimiento extends JDialog implements ActionListener
{
	...
	private boolean encontroregla;
	private int iddesdeantes;
	private int idhastaantes;
	
	public ModificarReglaConocimiento(InterfazInicio interfaz, String desde, String hasta)
	{
		super(interfaz, true);
		setLayout(new FlowLayout());
        setTitle("Modificar Regla Conocimiento - SESP");
        setResizable(false);
	  ...
	  //********************************************
	    ...
	    espacioa.setPreferredSize(new Dimension(370+aumentoancho,10));	
	    panelcolor.add(espacioa);
	    panelcolor.add(panel);
	    JLabel espaciob = new JLabel(" ");
	    espaciob.setPreferredSize(new Dimension(370+aumentoancho,10));	
	...
	public void actionPerformed(ActionEvent evento){
		...
		if (clic.equals("Aceptar"))
		{
			...
			{
				JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir el Id de "+desdeentidad,"Modificar Regla",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
			}
			else
			{
				...
				{
					JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir el Id de "+hastaentidad,"Modificar Regla",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
				}
				else
				{
					try 
					{
				        ...
				        {
							if(encontroregla == false)
							{
								Conector conectorf = new Conector();
				    			conectorf.iniciarConexionBaseDatos();
				    			PreguntaEscala existepreesc = PreguntaEscalaBD.consultar(idhasta, iddesde, conectorf);
				    			conectorf.terminarConexionBaseDatos();
				    			if(existepreesc != null)
				    			{
				    				encontroregla = true;
				    				iddesdeantes=iddesde;
				    				idhastaantes=idhasta;
				    				JOptionPane.showMessageDialog(this,"Mofifique los Id y luego haga Clic en Aceptar.","Modificar Regla", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
				    			}
				    			else
				    			{
				    				JOptionPane.showMessageDialog(this,"La regla entre "+desdeentidad+" y "+hastaentidad+" con los Id digitados no existe.","Modificar Regla", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
				    			}
							}
							else
							{
								...
								JOptionPane.showMessageDialog(this,panel,"Modificar Regla", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
								...
								try 
					    		{
					    			...
					    			if(existep == null)
					    			{
						    			...
						    			if(existepregunta != null)
						    			{
						    				if(existeescala != null)
							    			{
								    			...
								    			PreguntaEscalaBD.actualizar(idhastaantes, iddesdeantes, nuevapreguntaescala, conectorb);
							    				conectorb.terminarConexionBaseDatos();
							    				JOptionPane.showMessageDialog(this,"Se Modifico la regla entre "+desdeentidad+" y "+hastaentidad+" como base del conocimiento.","Modificar Regla", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
							    			}
							    			else
							    			{
					    			...
					    			{
					    				if(respuestaPredeterminada.equalsIgnoreCase(existep.getRespuesta()))
					    				{
					    					JOptionPane.showMessageDialog(this,"La regla entre "+desdeentidad+" y "+hastaentidad+" ya esta ingresada en la base del conocimineto","Modificar Regla", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
					    				}
					    				else
					    				{
					    					Conector conectorb = new Conector();
				        ...
				        if(desdeentidad.equalsIgnoreCase("Competencia") && hastaentidad.equalsIgnoreCase("Escala"))
				        {
				        	if(encontroregla == false)
							{
								Conector conectorf = new Conector();
				    			conectorf.iniciarConexionBaseDatos();
				    			CompetenciaEscala existecomescal = CompetenciaEscalaBD.consultar(iddesde, idhasta, conectorf);
				    			conectorf.terminarConexionBaseDatos();
				    			if(existecomescal != null)
				    			{
				    				encontroregla = true;
				    				iddesdeantes=iddesde;
				    				idhastaantes=idhasta;
				    			...
				    			{
				    				JOptionPane.showMessageDialog(this,"La regla entre "+desdeentidad+" y "+hastaentidad+" no existe en la base del conocimineto","Modificar Regla", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
				    			}
							}
							else
							{
					    			...
					    			if(existep == null)
					    			{
						    			...
						    			if(existecompetencia != null)
						    			{
						    				if(existeescala != null)
							    			{
						    					Conector conectorb = new Conector();
								    			conectorb.iniciarConexionBaseDatos();
								    			CompetenciaEscalaBD.actualizar(iddesdeantes, idhastaantes, nuevacompetenciaescala, conectorb);
							    				conectorb.terminarConexionBaseDatos();
								    			JOptionPane.showMessageDialog(this,"Se Modifico la regla entre "+desdeentidad+" y "+hastaentidad+" como base del conocimiento.","Modificar Regla", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
								    			dispose();
							    			}
				        ...
				        if(desdeentidad.equalsIgnoreCase("Competencia") && hastaentidad.equalsIgnoreCase("Rol"))
				        {
				        	if(encontroregla == false)
							{
								Conector conectorf = new Conector();
								conectorf.iniciarConexionBaseDatos();
				    			CompetenciaRol existecomrol = CompetenciaRolBD.consultar(iddesde, idhasta, conectorf);
				    			conectorf.terminarConexionBaseDatos();
				    			if(existecomrol != null)
				    			{
				    				encontroregla = true;
				    				iddesdeantes=iddesde;
				    				idhastaantes=idhasta;
					    			...
					    			if(existep == null)
					    			{
						    			...
						    			if(existecompetencia != null)
						    			{
						    				if(existerol != null)
							    			{
						    					Conector conectorb = new Conector();
								    			conectorb.iniciarConexionBaseDatos();
								    			CompetenciaRolBD.actualizar(iddesdeantes, idhastaantes, nuevacompetenciarol, conectorb);
							    				conectorb.terminarConexionBaseDatos();
							    				JOptionPane.showMessageDialog(this,"Se Modifico la regla entre "+desdeentidad+" y "+hastaentidad+" como base del conocimiento.","Modificar Regla", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
							    				dispose();
							    			}
