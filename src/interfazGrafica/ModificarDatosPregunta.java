 ...
 * 2012
 */
public class ModificarDatosPregunta extends JDialog implements ActionListener
{
	private JTable tbid;
	...
	public ModificarDatosPregunta(InterfazInicio interfaz, Pregunta encontrado)
	{
		super(interfaz, true);
		setLayout(new FlowLayout());
        setTitle("Modificar Datos Pregunta - SESP");
        setResizable(false);
		...
		inicio = interfaz;
		preguntaseleccionada = encontrado;
		//********************************************
		tbid = new JTable(1,2);
		tbid.setValueAt("ID PREGUNTA", 0, 0);
		tbid.setValueAt(preguntaseleccionada.getIdpregunta(), 0, 1);
		...
		// Set column widths
	    tcm2.getColumn(0).setPreferredWidth(140);
	    tcm2.getColumn(1).setPreferredWidth(760);
		...
		tbnumeropre.setValueAt(""+preguntaseleccionada.getOrdennumerico(), 0, 1);
	  ...
	  //********************************************
	    ...
	    tbtextopre.setValueAt(preguntaseleccionada.getTexto(), 0, 1);
		...
		int tbancho = 900;
		int tbalto = 3*((tbnumeropre.getRowCount()*20)+7);
	...
	public void actionPerformed(ActionEvent evento){
		...
		if (clic.equals("Aceptar"))
		{
			...
			{
				JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir el numero de orden de la pregunta.","Modificar Pregunta",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
			}
			else
			{
				...
				{
					JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir el texto de la pregunta.","Modificar Pregunta",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
				}
				else
				{
					try 
					{
						...
						preguntaseleccionada.setOrdennumerico(numeroorden);
						preguntaseleccionada.setTexto(textodigitado);
						try 
			    		{
			    			...
			    			if(existen == null)
			    			{
				    			...
				    			if(existep == null)
				    			{
				    				...
				    				PreguntaBD.actualizar(preguntaseleccionada, conectorc);
				    				conectorc.terminarConexionBaseDatos();
				    				JOptionPane.showMessageDialog(this,"Se Modifico la pregunta seleccionada.","Modificar Pregunta", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
				    			}
				    			else
				    			{
				    				JOptionPane.showMessageDialog(this,"Esta pregunta ya es parte de la base del conocimiento.","Modificar Pregunta", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
				    			}
			    			}
			    			else
			    			{
				    			...
				    			{
				    				JOptionPane.showMessageDialog(this,"Esta numero de orden para la pregunta ya esta adicionado.","Modificar Pregunta", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
				    			}
			    			}
			    		}
			    		catch (Exception e)
