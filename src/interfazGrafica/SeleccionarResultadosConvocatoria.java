 ...
 * 2012
 */
public class SeleccionarResultadosConvocatoria extends JDialog implements ActionListener
{
	...
	private String tiporesultadoselec;
	
	public SeleccionarResultadosConvocatoria(InterfazInicio interfaz, String tiporesultado)
	{
		super(interfaz, true);
		setLayout(new FlowLayout());
        setTitle("Seleccionar Resultados Convocatoria - SESP");
		setResizable(false);
		...
		inicio = interfaz;
		tiporesultadoselec = tiporesultado;
	...
	public void actionPerformed(ActionEvent evento){
		...
		if (clic.equals("Aceptar"))
		{
			...
			{
				this.dispose();
				if(convocatoriaselecconada.equalsIgnoreCase("Pruebas Libres"))
				{
					inicio.verVerResultado(tiporesultadoselec, "Pruebas Libres");
				}
				else
				{
				    inicio.verVerResultado(tiporesultadoselec, convocatoriaselecconada);
				}
			}
		}
