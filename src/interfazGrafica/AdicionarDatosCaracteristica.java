 ...
 * 2012
 */
public class AdicionarDatosCaracteristica extends JDialog implements ActionListener
{
	...
	public AdicionarDatosCaracteristica(InterfazInicio interfaz)
	{
		super(interfaz, true);
		setLayout(new FlowLayout());
        setTitle("Adicionar Datos Caracteristica - SESP");
        setResizable(false);
	...
	public void actionPerformed(ActionEvent evento){
		...
		if (clic.equals("Aceptar"))
		{
			...
			{
				JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir el nombre de la caracteristica.","Adicionar Caracteristica",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
			}
			else
			{
				...
				{
					JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir la descripcion de la caracteristica.","Adicionar Caracteristica",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
				}
				else
				{
					Caracteristica nuevacaracter = new Caracteristica();
					nuevacaracter.setNombre(nombredigitado.trim());
					nuevacaracter.setDescripcion(descripciondigitado.trim());
					inicio.prepararCaracterisiticaEscala(nuevacaracter);
		    		super.dispose();
				}
			}
		}
