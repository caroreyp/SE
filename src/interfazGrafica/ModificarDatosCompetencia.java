 ...
 * 2012
 */
public class ModificarDatosCompetencia extends JDialog implements ActionListener
{
	private JTable tbid;
	...
	private Competencia competencseleccionada;
	
	public ModificarDatosCompetencia(InterfazInicio interfaz, Competencia encontrado)
	{
		super(interfaz, true);
		setLayout(new FlowLayout());
        setTitle("Modificar Datos Competencia - SESP");
        setResizable(false);
		...
		inicio=interfaz;
		competencseleccionada = encontrado;
		//********************************************
		tbid = new JTable(1,2);
		tbid.setValueAt("ID COMPETENCIA", 0, 0);
		tbid.setValueAt(competencseleccionada.getIdcompetencia(), 0, 1);
		...
		tbnombre.setValueAt(""+competencseleccionada.getNombre(), 0, 1);
	  ...
	  //********************************************
	    ...
	    tbdescripcion.setValueAt(competencseleccionada.getDescripcion(), 0, 1);
	...
	public void actionPerformed(ActionEvent evento){
		...
		if (clic.equals("Aceptar"))
		{
			...
			{
				JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir el nombre de la competencia.","Modificar Competencia",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
			}
			else
			{
				...
				{
					JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir la descripcion de la competencia.","Modificar Competencia",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
				}
				else
				{
					competencseleccionada.setNombre(nombredigitado.trim());
					competencseleccionada.setDescripcion(descripciondigitado.trim());
					try 
		    		{
		    			...
		    			if(existen == null)
		    			{
			    			...
			    			CompetenciaBD.actualizar(competencseleccionada, conectorc);
		    				conectorc.terminarConexionBaseDatos();
			    			JOptionPane.showMessageDialog(this,"Se Modifico la competencia seleccionada.","Modificar Competencia", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
		    			}
		    			else
		    			{
		    				...
		    				{
		    					JOptionPane.showMessageDialog(this,"La escala con el nombre "+nombredigitado+" ya esta adicionada.","Modificar Competencia", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
		    				}
		    				else
		    				{
		    					Conector conectorc = new Conector();
