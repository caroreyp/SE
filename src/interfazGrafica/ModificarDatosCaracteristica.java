 ...
 * 2012
 */
public class ModificarDatosCaracteristica extends JDialog implements ActionListener
{
	private JTable tbid;
	...
	private Caracteristica caracterseleccionada;
	
	public ModificarDatosCaracteristica(InterfazInicio interfaz, Caracteristica encontrado)
	{
		super(interfaz, true);
		setLayout(new FlowLayout());
        setTitle("Modificar Datos Caracteristica - SESP");
        setResizable(false);
		...
		inicio=interfaz;
		caracterseleccionada = encontrado;
		//********************************************
		tbid = new JTable(1,2);
		tbid.setValueAt("ID CARACTERISTICA", 0, 0);
		tbid.setValueAt(caracterseleccionada.getIdcaracteristica(), 0, 1);
		...
		tbnombre.setValueAt(""+caracterseleccionada.getNombre(), 0, 1);
	    ...
	    tbdescripcion.setValueAt(caracterseleccionada.getDescripcion(), 0, 1);
		...
		int tbancho = 900;
		int tbalto = 3*((tbnombre.getRowCount()*20)+7);
		...
		panelcolor.setPreferredSize(new Dimension (950+aumentoancho,190+15));
	...
	public void actionPerformed(ActionEvent evento){
		...
		if (clic.equals("Aceptar"))
		{
			...
			{
				JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir el nombre de la caracteristica.","Modificar Caracteristica",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
			}
			else
			{
				...
				{
					JOptionPane.showMessageDialog(this,"Presione Enter al terminar de escribir la descripcion de la caracteristica.","Modificar Caracteristica",JOptionPane.WARNING_MESSAGE,new ImageIcon("./images/IconosInterfaz/advertencia.PNG"));
				}
				else
				{
					caracterseleccionada.setNombre(nombredigitado.trim());
					caracterseleccionada.setDescripcion(descripciondigitado.trim());
					try 
		    		{
		    			Conector conectora = new Conector();
		    			conectora.iniciarConexionBaseDatos();
		    			Caracteristica existen = CaracteristicaBD.buscarNombre(nombredigitado.trim(), conectora);
		    			conectora.terminarConexionBaseDatos();
		    			if(existen == null)
		    			{
		    				Conector conectorc = new Conector();
			    			conectorc.iniciarConexionBaseDatos();
			    			CaracteristicaBD.actualizar(caracterseleccionada, conectorc);
		    				conectorc.terminarConexionBaseDatos();
			    			JOptionPane.showMessageDialog(this,"Se Modifico la caracteristica seleccionada.","Modificar Caracteristica", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
		    			}
		    			else
		    			{
		    				...
		    				{
		    					JOptionPane.showMessageDialog(this,"La caracteristica con el nombre "+nombredigitado+" ya esta adicionada.","Modificar Caracteristica", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
		    				}
		    				else
		    				{
		    					Conector conectorc = new Conector();
				    			...
				    			CaracteristicaBD.actualizar(caracterseleccionada, conectorc);
			    				conectorc.terminarConexionBaseDatos();
				    			JOptionPane.showMessageDialog(this,"Se Modifico la competencia seleccionada.","Modificar Caracteristica", JOptionPane.INFORMATION_MESSAGE,new ImageIcon("./images/IconosInterfaz/informacion.PNG"));
		    				}
		    			}
		    		}
		    		catch (Exception e)
